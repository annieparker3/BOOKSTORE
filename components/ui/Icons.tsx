...
export const WandSparklesIcon: React.FC<IconProps> = (props) => (
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m5 3 2.5 5L12 5.5 9.5 8 12 13 5 3z" />
        <path d="m12 13 2.5 5L19 15.5 16.5 18l2.5 5-7-10z" />
        <path d="M22 2 20 4" />
        <path d="m7 21 2-2" />
        <path d="m3 14 2-2" />
        <path d="m19 9 2-2" />
...
export const MicroscopeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M9 14v2" />
        <path d="M9 5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2Z" />
        <path d="M12 5a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2Z" />
    </svg>
);
